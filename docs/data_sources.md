...
The primary batch/file source is **Sleep-EDF Database Expanded v1.0.0**,
...
Phase 11 adds an internal simulated source:
...
It represents a BCI/wearable-style event stream for exercising streaming
engineering behavior. It is generated by project code rather than downloaded
...
The simulated source is deliberately small in domain complexity; the engineering
focus is event contracts, partitioning, durable ingestion, deduplication,
restart behavior, quarantine, event-time handling, and Warehouse integration.
